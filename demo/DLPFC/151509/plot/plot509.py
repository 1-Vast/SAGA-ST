...
# 1. 文件路径
# =========================================================
h5ad_path = "/root/autodl-tmp/Spatial-main/dataset/DLPFC/151509.h5ad"
label_path = "/root/autodl-tmp/Spatial-main/demo/DLPFC/151509/train/151509_baseline_k15.augK3_d96_for_cluster.robust.labels.txt"

out_dir = Path("/root/autodl-tmp/paper_figures")
out_dir.mkdir(parents=True, exist_ok=True)

out_png = out_dir / "151509_layer_cluster_darkmatch.png"
...
# 标题
ax.set_title("151509", fontsize=16, pad=12)
