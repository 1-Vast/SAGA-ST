...
# 1. 文件路径
# =========================================================
h5ad_path = "/root/autodl-tmp/Spatial-main/dataset/DLPFC/151675.h5ad"
label_path = "/root/autodl-tmp/Spatial-main/demo/DLPFC/151675/train/151675_v1_test2.mclust.labels.txt"

out_dir = Path("/root/autodl-tmp/paper_figures")
out_dir.mkdir(parents=True, exist_ok=True)

out_png = out_dir / "151675_layer_cluster_darkmatch.png"
...
# 标题
ax.set_title("151675", fontsize=16, pad=12)
