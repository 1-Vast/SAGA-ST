...
# 1. 文件路径
# =========================================================
h5ad_path = "/root/autodl-tmp/Spatial-main/dataset/DLPFC/151510.h5ad"
label_path = "/root/autodl-tmp/Spatial-main/demo/DLPFC/151510/train/151510_Masterpiece_wspa0.35.robust.labels.txt"

out_dir = Path("/root/autodl-tmp/paper_figures")
out_dir.mkdir(parents=True, exist_ok=True)

out_png = out_dir / "151510_layer_cluster_darkmatch.png"
...
# 标题
ax.set_title("151510", fontsize=16, pad=12)
