...
# 1. 文件路径
# =========================================================
h5ad_path = "/root/autodl-tmp/Spatial-main/dataset/DLPFC/151676.h5ad"
label_path = "/root/autodl-tmp/Spatial-main/demo/DLPFC/151676/train/no_merge_check.mclust.labels.txt"

out_dir = Path("/root/autodl-tmp/paper_figures")
out_dir.mkdir(parents=True, exist_ok=True)

out_png = out_dir / "151676_layer_cluster_darkmatch.png"
...
# 标题
ax.set_title("151676", fontsize=16, pad=12)
