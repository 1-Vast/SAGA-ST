...
# 输入文件
# =============================
h5ad = "/root/autodl-tmp/Mouse/E12.5_E1S2.MOSTA.h5ad"
labels = "/root/autodl-tmp/demo/mouse/12_E1S2/E12.5_E1S2.label.txt"
...
# 标题
# =============================
ax.set_title("E12.5(ARI: 0.4287)",fontsize=16,pad=15)

plt.tight_layout()

plt.savefig("/root/autodl-tmp/E12.5_E1S2_paper_style.png",dpi=600,bbox_inches="tight")
plt.savefig("/root/autodl-tmp/E12.5_E1S2_paper_style.pdf",bbox_inches="tight")
