...
# 输入文件
# =============================
h5ad = "/root/autodl-tmp/Mouse/E14.5_E1S3.MOSTA.h5ad"
labels = "/root/autodl-tmp/Spatial-main/demo/mouse/14_E1S3/E14.5_E1S3_SSL_A_leiden.leiden.labels.txt"
...
# 标题
# =============================
ax.set_title("E14.5_E1S3 (ARI: 0.5015)",fontsize=16,pad=15)

plt.tight_layout()

plt.savefig("/root/autodl-tmp/E14.5_E1S3_paper_style.png",dpi=600,bbox_inches="tight")
plt.savefig("/root/autodl-tmp/E14.5_E1S3_paper_style.pdf",bbox_inches="tight")
