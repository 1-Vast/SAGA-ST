...
# 输入文件
# =============================
h5ad = "/root/autodl-tmp/Mouse/E13.5_E1S4.MOSTA.h5ad"
labels = "/root/autodl-tmp/demo/mouse/13_E1S4/E13.5_E1S4.label.txt"
...
# 标题
# =============================
ax.set_title("E13.5(ARI: 0.3893)",fontsize=16,pad=15)

plt.tight_layout()

plt.savefig("/root/autodl-tmp/E13.5_E1S4_paper_style.png",dpi=600,bbox_inches="tight")
plt.savefig("/root/autodl-tmp/E13.5_E1S4_paper_style.pdf",bbox_inches="tight")
